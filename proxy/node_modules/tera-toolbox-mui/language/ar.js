...
function GetString(str, tokens) {
    switch (str) {
        // connection-manager
        case 'connection-manager/error-ETIMEDOUT-1': return `[connection] :الأسباب الشائعة لهذا هى ${tokens.address}:${tokens.port} (timeout)! خطأ: غير قادر على الإتصال بخادم اللعبة على`;
        case 'connection-manager/error-ETIMEDOUT-2': return '[connection] - IP شبكة إنترنت غير مستقرة أو حظر جغرافي';
        case 'connection-manager/error-ETIMEDOUT-3': return '[connection] - جارى صيانة خادم اللعبة';
