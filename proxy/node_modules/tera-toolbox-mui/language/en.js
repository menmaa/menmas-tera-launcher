...
function GetString(str, tokens) {
    switch (str) {
        // connection-manager
        case 'connection-manager/error-ETIMEDOUT-1': return `[connection] ERROR: Unable to connect to game server at ${tokens.address}:${tokens.port} (timeout)! Common reasons for this are:`;
        case 'connection-manager/error-ETIMEDOUT-2': return '[connection] - An unstable internet connection or a geo-IP ban';
        case 'connection-manager/error-ETIMEDOUT-3': return '[connection] - Game server maintenance';
