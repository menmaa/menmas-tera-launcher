...
function GetString(str, tokens) {
    switch (str) {
        // connection-manager
        case 'connection-manager/error-ETIMEDOUT-1': return `[Verbindung] FEHLER: Verbindung zum Spiel-Server unter ${tokens.address}:${tokens.port} (Zeitüberschreitung) nicht möglich! Häufige Gründe hierfür sind:`;
        case 'connection-manager/error-ETIMEDOUT-2': return '[Verbindung] - Eine instabile Internetverbindung oder eine regionale IP-Sperre';
        case 'connection-manager/error-ETIMEDOUT-3': return '[Verbindung] - Wartung des Spiel-Servers';
