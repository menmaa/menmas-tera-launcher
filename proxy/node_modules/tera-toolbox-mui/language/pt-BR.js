...
function GetString(str, tokens) {
    switch (str) {
        // connection-manager
        case 'connection-manager/error-ETIMEDOUT-1': return `[connection] ERRO: Não foi possível conectar com o servidor em ${tokens.address}:${tokens.port} (tempo esgotado)! Razões comuns para isso são:`;
        case 'connection-manager/error-ETIMEDOUT-2': return '[connection] - Uma conexão de Internet instável ou um Ban geográfico de IP';
        case 'connection-manager/error-ETIMEDOUT-3': return '[connection] - Manutenção dos servidores do jogo';
