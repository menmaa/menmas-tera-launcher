...
function GetString(str, tokens) {
    switch (str) {
        // connection-manager
        case 'connection-manager/error-ETIMEDOUT-1': return `[połączenie] BŁĄD: Wystąpił problem z połączeniem z serwerem gry w ${tokens.address}:${tokens.port} (timeout)! Najczęściej jest to spowodowane:`;
        case 'connection-manager/error-ETIMEDOUT-2': return '[połączenie] - Niestabilnym połączeniem sieciowym, lub blokadą regionalną (geo-IP ban)';
        case 'connection-manager/error-ETIMEDOUT-3': return '[połączenie] - Prace serwisowe na serwerach gry';
