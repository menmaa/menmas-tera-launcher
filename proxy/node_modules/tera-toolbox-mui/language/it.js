...
function GetString(str, tokens) {
    switch (str) {
        // connection-manager
        case 'connection-manager/error-ETIMEDOUT-1': return `[connection] ERRORE: Impossibile connettersi al server di gioco all'indirizzo ${tokens.address}:${tokens.port} (tempo scaduto)! Alcune possibili cause possono essere:`;
        case 'connection-manager/error-ETIMEDOUT-2': return '[connection] - Una connessione instabile o un ban IP geografico';
        case 'connection-manager/error-ETIMEDOUT-3': return '[connection] - Manutenzione dei server di gioco';
