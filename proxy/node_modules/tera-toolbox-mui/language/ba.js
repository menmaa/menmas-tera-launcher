...
function GetString(str, tokens) {
    switch (str) {
        // connection-manager
        case 'connection-manager/error-ETIMEDOUT-1': return `[connection] GREŠKA: Nemoguće uspostaviti vezu sa serverom ${tokens.address}:${tokens.port} (timeout)! Česti razlozi za ovo su:`;
        case 'connection-manager/error-ETIMEDOUT-2': return '[connection] - Nestabilna konekcija sa serverom ili geo-IP ban';
        case 'connection-manager/error-ETIMEDOUT-3': return '[connection] - Server održavanje';
