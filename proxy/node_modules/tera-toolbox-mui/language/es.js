...
function GetString(str, tokens) {
    switch (str) {
        // connection-manager
        case 'connection-manager/error-ETIMEDOUT-1': return `[connection] ERROR: Imposible conectarse al servidor del juego en ${tokens.address}:${tokens.port} (timeout)! Los motivos comunes de esto pueden ser:`;
        case 'connection-manager/error-ETIMEDOUT-2': return '[connection] - Una conección de internet inestable o un IP ban';
        case 'connection-manager/error-ETIMEDOUT-3': return '[connection] - Servidor del juego en mantenimiento';
